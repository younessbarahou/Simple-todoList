...
export default function Task(){
    ...
    return (
        ...
        <div className="bg-yellow-400 flex text-black justify-between sm:justify-normal gap-3 sm:gap-0  pt-5 pb-5 pl-3 pr-4 rounded-lg ml-4 mr-4 mt-16 sm:max-w-xl sm:ml-auto sm:mr-auto sm:relative">
